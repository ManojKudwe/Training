 ...
 <!--header-starts-->
  ...
  <div class="section content_section">
	<div class="container">
		...
		<form name="myForm" action="" onsubmit="return validatecat()"  method="post">
...
$qry = mysqli_query($con,"select * from categ where category='$id'"); 
...
if(isset($_POST['update'])) 
{
    ...
    $edit = mysqli_query($con,"update categ set category='$category' where category='$id'");
