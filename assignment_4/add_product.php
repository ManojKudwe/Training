...
if(!empty($_POST['pname']))
{
    ...
    $check = mysqli_query($con,"INSERT INTO `cate` (`category`,`pname`,`price`,`pimage`) VALUES ('$cate','$pname','$price','$dst_db')");  
