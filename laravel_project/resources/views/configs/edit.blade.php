                        ...
                        <div class="card-body">
                          <div class="form-group">
                                <label for="config_name"> Configuration_name <span class="text-danger"> * </span> </label>
                                    <input type="text" name="config_name" class="form-control" value="{{$config->config_name}}" />
							...
							<div class="form-group">
                                <label for="config_value">  Configuration_value <span class="text-danger"> * </span> </label>
                                    <input type="text" name="config_value" class="form-control" value="{{$config->config_value}}" />
